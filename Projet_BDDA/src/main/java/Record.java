...
public class Record {
    ...
    public String getValue(String nomColonne) {
        for (int i = 0; i < colonnes.length; i++) {
            if (nomColonne.equals("col" + (i + 1))) {
                return colonnes[i];
            }
        }
        return null;
    ...
    public void setValue(String nomColonne, String valeur) {
        for (int i = 0; i < colonnes.length; i++) {
            if (nomColonne.equals("col" + (i + 1))) {
                colonnes[i] = valeur;  // Modifier la valeur de la colonne correspondante
                return;
            }
        }
    }
