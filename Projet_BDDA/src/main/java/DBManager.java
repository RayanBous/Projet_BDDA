...
public class DBManager {
    ...
    public void RemoveDatabase(){
        ...
        if(!databases.containsKey(nom)){
            ...
            System.out.println("BASE DE DONNEE : " + databases);
    ...
    public void RemoveDatabases(){
        if (databases != null && !databases.isEmpty()) {
            ...
            databases.clear();
            System.out.println("BASE DE DONNEE (METHODE DATABASESSSS) : " + databases);
    ...
    public void SaveState() {
        String chemin = dbconfig.getDbPath() + "/BinData/databases.save.json";
